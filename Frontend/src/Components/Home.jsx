    ...
    >
      <div>
        <div className="d-flex align-items-center justify-content-center">
          <div
            className="d-flex   gap-4 rounded-5  py-1 px-4  mb-4 "
            style={{
        ...
        <div className="">
          <p
            ...
            style={{ fontSize: "20px", fontWeight: "400", font: "Public Sans" }}
          >
        ...
        <div
          className="d-flex mt-2 text-center justify-content-center"
          style={{
            fontSize: "13px",
            fontWeight: "200",
